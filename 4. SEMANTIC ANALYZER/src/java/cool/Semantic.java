...
public class Semantic{
	...
	//private ArrayList<String, List<feature> > ast = new ArrayList<String, List<feature> >();
	private ScopeTable<AST.attr> table = new ScopeTable<AST.attr>();
	private String filename = "fuck_this_shit_Seriously_FUCK_IT_Hard_in the fucking ass_BC_MC_Bhosdike";
